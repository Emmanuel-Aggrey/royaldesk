...
from HRMSPROJECT.custome_decorators import default_passeord
from .import views
app_name = 'helpdesk'

urlpatterns = [
    # path('change-default-password/', views.change_default_passwords, name='change_default_passwords'),
    path('helpdesk/',login_required(default_passeord(TemplateView.as_view(template_name="helpdesk/helpdesk.html"))),name='helpdesk'),
