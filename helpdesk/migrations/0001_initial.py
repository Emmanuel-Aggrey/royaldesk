    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handle_over_to', models.ForeignKey(blank=True, default=4, null=True, on_delete=django.db.models.deletion.CASCADE, to='helpdesk.user')),
            ],
            options={
                'ordering': ('-updated_at',),
            },
        ...
        migrations.AddField(
            model_name='helpdesk',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='helpdesk_users', to='helpdesk.user'),
        ),
    ]
