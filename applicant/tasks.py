...
def send_applicant_email_selected(applicant_name, applicant_email, designation, department,applicant_id):
    ...
    subject = 'Dear  {}'.format(applicant_name)
    subject_ = subject.upper()
    html_content = 'Your Applicantion For {} in {} Department At Rock City Hotel Kuahu Nquatia have been selected Please <a href="http://192.168.43.212:8000/applicant/">Click Here</a> to download your offer letter <br> your Unique Identifier is <b>{}</b> in case you lost it Thank you <br><hr> <br> <footer><b>POWERD BY <a href="http://192.168.43.212:8000/"> ROYALDESK </a> RCH</b> </footer>'.format(
        designation, department,applicant_id)
